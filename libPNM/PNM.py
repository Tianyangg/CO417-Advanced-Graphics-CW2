...
libPNM = cdll.LoadLibrary('/Users/tianyangsun/Documents/Imperial_S2/Advanced_graphics/CO417-Assignment1/libPNM/libPNM.so')  # Change to the absolute path where libPNM.so is saved
